...
/*   Updated: 2024/05/23 12:46:24 by vbritto-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_error_bonus(int i)
{
	if (i == 1)
	{
		...
		write(2, "Try: ./pipex_bonus file1 cmd1 cmd2 cmd3 ... file2\n", 44);
		write(2, "Or: ./pipex_bonus here_doc cmd1 cmd2 cmd3 file2\n", 42);
	}
	else if (i == 2)
		perror("Error: Pipe\n");
	else if (i == 3)
